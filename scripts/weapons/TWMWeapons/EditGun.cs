...
switch(%obj.EditPMode) {
   ...
   case 2:
      ...
      switch(%obj.EditSMode) {
          case 0:
             commandToClient( %obj.client, 'BottomPrint', "<spush><font:Tempus Sans ITC:20><color:ff3300>[{Texture Tool}] - Phantom139 \n Mine: Pad Swap - FF Swap - [Barrel Swap] - Cloak/Fade - Delete Objects \n <font:Tempus Sans ITC:18> Grenade: Mortar - [Anti Air] - Flame Thrower<spop>", 5, 3);
          case 1:
              commandToClient( %obj.client, 'BottomPrint', "<spush><font:Tempus Sans ITC:20><color:ff3300>[{Texture Tool}] - Phantom139 \n Mine: Pad Swap - FF Swap - [Barrel Swap] - Cloak/Fade - Delete Objects \n <font:Tempus Sans ITC:18> Grenade: Anti-Air - [Flame Thrower] - Missile<spop>", 5, 3);
          case 2:
              commandToClient( %obj.client, 'BottomPrint', "<spush><font:Tempus Sans ITC:20><color:ff3300>[{Texture Tool}] - Phantom139 \n Mine: Pad Swap - FF Swap - [Barrel Swap] - Cloak/Fade - Delete Objects \n <font:Tempus Sans ITC:18> Grenade: FlameThrower - [Missile] - Artillery<spop>", 5, 3);
          case 3:
              commandToClient( %obj.client, 'BottomPrint', "<spush><font:Tempus Sans ITC:20><color:ff3300>[{Texture Tool}] - Phantom139 \n Mine: Pad Swap - FF Swap - [Barrel Swap] - Cloak/Fade - Delete Objects \n <font:Tempus Sans ITC:18> Grenade: Missile - [Artillery] - Chaingun<spop>", 5, 3);
          case 4:
              commandToClient( %obj.client, 'BottomPrint', "<spush><font:Tempus Sans ITC:20><color:ff3300>[{Texture Tool}] - Phantom139 \n Mine: Pad Swap - FF Swap - [Barrel Swap] - Cloak/Fade - Delete Objects \n <font:Tempus Sans ITC:18> Grenade: Artillery - [Chaingun] - Mortar<spop>", 5, 3);
          case 5:
              commandToClient( %obj.client, 'BottomPrint', "<spush><font:Tempus Sans ITC:20><color:ff3300>[{Texture Tool}] - Phantom139 \n Mine: Pad Swap - FF Swap - [Barrel Swap] - Cloak/Fade - Delete Objects \n <font:Tempus Sans ITC:18> Grenade: Chaingun - [Mortar] - Anti Air<spop>", 5, 3);
      }
   case 3:
      switch(%obj.EditSMode) {
         case 0:
...
else if(%this.EditPMode == 2 && %this.EditSMode > 5) {
%this.EditSMode = 0;
}
...
function EToolTurrets(%tobj,%plyr,%Mode) {
   ...
   if(%classname $= "TurretBaseLarge" || %classname $= "TurretDeployedBase") {
      switch$(%mode) {         //Thanks for help on this Krash..
       ...
       messageclient(%cl, 'MsgClient', '\c5TextureTool: Swapping Barrel with Flamethrower Barrel.');
       case 2:
       %tobj.mountImage("MissileBarrelLarge", 0);
       messageclient(%cl, 'MsgClient', '\c5TextureTool: Swapping Barrel with Missile Barrel.');
       case 3:
       %tobj.mountImage("ArtilleryBarrelLarge", 0);
       messageclient(%cl, 'MsgClient', '\c5TextureTool: Swapping Barrel with Artillery Barrel.');
       case 4:
       %tobj.mountImage("PlasmaBarrelLarge", 0);
       messageclient(%cl, 'MsgClient', '\c5TextureTool: Swapping Barrel with Chaingun Barrel.');
       case 5:
