...
function MTShowStatus(%client)
{
	...
	switch (%client.MTMode)
	{
       ...
       case 3:
			switch (%client.MTSubMode) {
               case 0:
					%status = "<font:Arial:14>Mode: Move. Fire at a piece to move it. Axis: X(+).";
               case 1:
					%status = "<font:Arial:14>Mode: Move. Fire at a piece to move it. Axis: X(-).";
               case 2:
					%status = "<font:Arial:14>Mode: Move. Fire at a piece to move it. Axis: Y(+).";
               case 3:
					%status = "<font:Arial:14>Mode: Move. Fire at a piece to move it. Axis: Y(-).";
               case 4:
					%status = "<font:Arial:14>Mode: Move. Fire at a piece to move it. Axis: Z(+).";
               case 5:
					%status = "<font:Arial:14>Mode: Move. Fire at a piece to move it. Axis: Z(-).";
            }
       case 4:
			switch (%client.MTSubMode) {
               ...
               case 2:
					%status = "<font:Arial:14>Mode: Full Scale. Fire at a piece to scale it. Grow .1M.";
               case 3:
					%status = "<font:Arial:14>Mode: Full Scale. Fire at a piece to scale it. Shrink .1M.";
               case 4:
					%status = "<font:Arial:14>Mode: Full Scale. Fire at a piece to scale it. Grow 1M.";
               case 5:
					%status = "<font:Arial:14>Mode: Full Scale. Fire at a piece to scale it. Shrink 1M.";
