...
$ReverseDeployItem[TurretplasDeployedOutdoor] = TurretPlasOutdoorDeployable;
$ReverseDeployItem[TurretDeployedFloor30Indoor] = TurretIndoor30calDeployable;
$ReverseDeployItem[TurretDeployedWall30Indoor] = TurretIndoor30calDeployable;
$ReverseDeployItem[TurretDeployedCeiling30Indoor] = TurretIndoor30calDeployable;
		...
		if (%canPerform == true) {
			...
			if (%hTgt != %obj.performing) { // its not what we were originally rotating
				...
				if (%obj.performTime < 0) { // we have a rot!
                    ...
                    if(%obj.client.RotateAngle $= "" || %obj.client.RotateAngle == 0) {
